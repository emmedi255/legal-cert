...
<body>
  ...
  <div>
    ...
    <div class="riga-intestazione">
      TITOLARE: ${intestazione.condominio}-${intestazione.indirizzo_condominio || ""} - C.F.: ${intestazione.cfCondominio || ""} - Rev. 01.00 del ${dataOggi}
    </div>
...
`,
  ...
  `,
    ...
    const path = `pdfs/REGISTRO_TRATTAMENTI_CONDOMINIO-${condominio_id}.pdf`;
