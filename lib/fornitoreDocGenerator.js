...
<div style="margin-top: 5cm; text-align: center; font-family: 'Times New Roman', serif;">
  ...
  <p>Il Condominio ${intestazione.condominio}, ${intestazione.condominio_indirizzo}, ${intestazione.cap} ${intestazione.citta}(${intestazione.provincia}) C.F. ${intestazione.cfCondominio} previa verifica della
...
`,
  ...
  `,
    ...
    const path = `pdfs/NOMINA_RESPONSABILE_ESTERNO_${fornitore.nome}_${fornitore.cognome}-${condominio_id}${fornitore.fornitore_id}.pdf`;
